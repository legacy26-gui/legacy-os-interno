    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-foreground-muted mt-0.5">Indicadores, custos e recebimento por cliente</p>
        </div>
        <div className="flex items-center gap-2">
          <Link
            href={`/financeiro/analise?month=${prevMonth}`}
          ...
          <Link
            href={`/financeiro/analise?month=${nextMonth}`}
            className="p-2 rounded-lg border border-border bg-surface hover:bg-surface-muted transition-colors"
            title="Próximo mês"
          >
